...
每天早上自动推送超星课程表 + 西安石油大学鄠邑校区天气到飞书，每节课前 15 分钟自动推送下一节课信息。
...
| 第1节课程 | 周一至周五 8:05 | 下一节课信息（8:20 上课） |
| 第2节课程 | 周一至周五 10:05 | 下一节课信息（10:20 上课） |
| 第3节课程 | 周一至周五 13:45 | 下一节课信息（14:00 上课） |
| 第4节课程 | 周一至周五 15:45 | 下一节课信息（16:00 上课） |
| 第5节课程 | 周一至周五 18:45 | 下一节课信息（19:00 上课） |
...
课程提醒触发后，脚本自动识别未来 30 分钟内的课程，sleep 到课前 15 分钟准时发送；若启动时已上课但不超过 30 分钟，仍会补发。
...
3. Note 填 `cron-job-trigger`，Expiration 选 `No expiration`
4. 勾选 `repo` 权限
...
- **课程提醒**：自动识别未来 30 分钟内课程，精确 sleep 到课前 15 分钟，上课 30 分钟内补发兜底
